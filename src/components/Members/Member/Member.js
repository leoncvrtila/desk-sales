...
class Member extends Component {                                            // modalni prozor koji se otvara klikom na clana
    ...
    componentDidMount() {
        ...
        axios.get('https://desk-hzf.firebaseio.com/form.json')
          .then(response => {
    ...
    deleteMemberHandler = () => {
        /*axios.delete('https://desk-hzf.firebaseio.com/member/' + this.props.selectedMemberId + '.json')       // brisanje clana
        .then(response => {
        ...
        axios.put('https://desk-hzf.firebaseio.com/member/' + this.props.selectedMemberId + '.json', {  // deaktivacija clana - prvo brisanje pa postavljanje active na 'ne' 
            ...
            interes: this.props.selectedMemberinteres,
    ...
    changeEditModeInteres = () => {

        this.setState(prevState => ({
            isInEditModeInteres: !prevState.isInEditModeInteres
        }))
    ...
    updateInteresValue = () => {
        this.setState({
            isInEditModeInteres: false,
            valueInteres: this.refs.InteresInput.value
        })
    }
    ...
    exitMemberHandler = () => {
        ...
        axios.put('https://desk-hzf.firebaseio.com/member/' + this.props.selectedMemberId + '.json', {                                                       // slanje novog clana
            ...
            interes: this.state.valueInteres ? this.state.valueInteres : this.props.selectedMemberinteres,
        ...
        if (                                   // ukoliko je otvoren i jedan prozor da se uredi podatak i ako nakon toga nije zatvoren onda pri izlasku iz modala zatvori prozor
            ...
            (this.state.isInEditModeInteres === true) ||
            ...
            <Aux>
                    ...
                    <div className="modalMemberWrap"  style={{display: this.props.selectedMember ? 'flex' : 'none'}}>
                        ...
                        <div className="modalMember">
                            ...
                            <div className="modalMemberProp"><h4>Polje interesa</h4>{this.state.isInEditModeInteres ? <div><input className="InputElement" type="text" defaultValue={this.state.valueInteres ? this.state.valueInteres : this.props.selectedMemberinteres} ref="InteresInput"/>
                            <button onClick={this.updateInteresValue}>✓</button><button onClick={this.changeEditModeInteres}>X</button></div> : 
                            <div className="modalMemberItem" onClick={this.changeEditModeInteres}>{this.state.valueInteres ? this.state.valueInteres : this.props.selectedMemberinteres}</div>}</div> 
