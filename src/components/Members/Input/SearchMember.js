...
class SearchMember extends Component {
    ...
    componentDidMount() {
        ...
        axios.all([
            axios.get('https://desk-clients.firebaseio.com/clients.json?auth=' + this.props.isAuth),
    ...
    clearAllHandler = () => {
        ...
        axios.get('https://desk-hzf.firebaseio.com/form.json')        // kada se stisne ocisti ponovo se napravi rueqest
         .then(response => {
    ...
    selectedMemberHandler = (imgUrl, id, oib, name, surname, sex, birthdate, stateOfBirth, county, city, township, address, zipCode, tel, 
        ...
        centralCommittee, presidency, president, vicePresident, secretary, supervisoryBoard, date, nogomet, ribolov, bela, pikado, humanitarian, cardNum, valueId, lastMembership, interes) => 
        {        
    ...
    exitMemberHandler = () => {
        ...
        setTimeout(() => {
            ...
            axios.get('https://desk-hzf.firebaseio.com/member.json?auth=' + this.props.isAuth)
              .then(response => {
    ...
    deleteAllHandler = () => {
        axios.delete('https://desk-hzf.firebaseio.com/member.json')       // brisanje svih clanova
                .then(response => {
        ...
        setTimeout(() => {
            ...
            axios.get('https://desk-hzf.firebaseio.com/member.json')
              .then(response => {
                ...
                return(  <MemberItem 
                         ...
                         //nogomet={i.nogomet}
                          ...
                          selectedMember={() => this.selectedMemberHandler(                             // onClick - kada se klikne na odredenog clana onda se podatci koji su oznaceni prebacuju u modal (Member.js)
                              ...
                              i.secretary, i.supervisoryBoard, i.date, i.nogomet, i.ribolov, i.bela, i.pikado, i.humanitarian, i.cardNum, i.valueId, i.lastMembership, i.interes
                           )}
                      />
            ...
            let xmlMap = this.state.members.map(i => {
                return <p>
                        {'<row>'}
                            ...
                            <p>{'<status>' + i.status +'</status>'}</p>
                            <p>{'<interes>' + i.interes +'</interes>'}</p>
        ...
        return(
            ...
            <Aux>
                ...
                <Member                                                                         // modalni prozor kad se odabere neki clan
                    ...
                    selectedMemberinteres={this.state.selectedMemberinteres}
