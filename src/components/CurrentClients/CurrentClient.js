...
class PotentialClient extends Component {
    ...
    state={
        ...
        service: '',
        allServices: [
          {department: 'Analytics, Marketing & Branding, Plans Development', endDate: '', value: 19, id: 0, active: false, title: 'BES'},
          {department: 'Marketing & Branding', endDate: '', value: 4, id: 1, active: false, title: 'Redizajn web stranice'},
          {department: 'Marketing & Branding', endDate: '', value: 8, id: 2, active: false, title: 'Redizajn web shopa'},
          {department: 'Marketing & Branding', endDate: '', value: 2, id: 3, active: false, title: 'Redizajn logotipa'},
          {department: 'Marketing & Branding', endDate: '', value: 2, id: 4, active: false, title: 'Izrada kupona'},
          {department: 'Marketing & Branding', endDate: '', value: 2, id: 5, active: false, title: 'Izrada sadržaja za web stranicu'},
          {department: 'Marketing & Branding', endDate: '', value: 3, id: 6, active: false, title: 'Izrada oglasa'},
          {department: 'Marketing & Branding', endDate: '', value: 1, id: 7, active: false, title: 'Održavanje oglasa'},
          {department: 'Marketing & Branding', endDate: '', value: 1, id: 8, active: false, title: 'Održavanje web stranice'},
          {department: 'Marketing & Branding', endDate: '', value: 1, id: 9, active: false, title: 'Održavanje web shopa'},
          {department: 'Analytics', endDate: '', value: 3, id: 10, active: false, title: 'Analiza'},
          {department: 'Plans Development', endDate: '', value: 4, id: 11, active: false, title: 'Optimizacija'},
          {department: 'Marketing & Branding', endDate: '', value: 1, id: 12, active: false, title: 'Potpis za email'}
        ],
        bes: [
          {department: 'Analytics', endDate: '', value: 4, id: 0, active: false, title: 'Analiza i struktura podataka'},
          {department: 'Marketing & Branding', endDate: '', value: 2, id: 1, active: false, title: 'Optimizacija trenutnih postavki'},
          {department: 'Marketing & Branding', endDate: '', value: 2, id: 2, active: false, title: 'Jedinstveni koncept predstavljanja'},
          {department: 'Marketing & Branding', endDate: '', value: 5, id: 3, active: false, title: 'Građenje kanala'},
          {department: 'Marketing & Branding', endDate: '', value: 1, id: 4, active: false, title: 'Oraganizacija kanala - Desk'},
          {department: 'Marketing & Branding', endDate: '', value: 2, id: 5, active: false, title: 'Strategija privlačenja klijenata'},
          {department: 'Plans Development', endDate: '', value: 3, id: 6, active: false, title: 'Kompletan A-to-B plan'}
        ],
        allServicesClick: false,
        searchValue: '',
        technicalInfoModal: false,
        domena: '',
        webSiteUsername: '',
        webSitePassword: '',
        cPanelUsername: '',
    ...
    downloadOfferHandler = (e,num) => {
      ...
      let today = new Date();
        ...
        setTimeout(() => {
        if(this.state.potentionalClient){

          for(let key in years){

            if(this.state.potentionalClient.offers[this.state.potentionalClient.offers.length-1].date.includes(years[key].year)){
      ...
      },
      {
        ...
        },
        {
          ...
          table: {
            ...
            widths: [ 550 ],
            body: [
                [ {text: 'Ponuda broj: ' + this.state.potentionalClient.offers[this.state.potentionalClient.offers.length-1].offerNum + '/' + realYear, alignment: 'center'}]
            ],
          },
          margin: [10, 13, 10, 10]
        },
   ...
   pdfMake.createPdf(docDefinition).download('Ponuda.pdf');
    ...
    billCloseHandler = (e,id, num) => {
      this.setState({
        billHandler: false
      })
    }

    billSaveHandler = () => { // kreiranje računa 
      ...
      if(this.state.billName !== ''){
        ...
        axios.put('https://desk-clients.firebaseio.com/potentional-clients/'  + this.state.potentionalClient.id + '.json?auth=' + this.props.isAuth, {
          ...this.state.potentionalClient,
          oib: this.state.billName,
          bills:[
            {
              billNum: this.state.potentionalClient.offers[this.state.potentionalClient.offers.length-1].offerNum,
              price: this.state.potentionalClient.offers[this.state.potentionalClient.offers.length-1].price,
              billPriceWords: this.state.potentionalClient.offers[this.state.potentionalClient.offers.length-1].wordPrice,
              date: today,
              day: day,
...
setTimeout(() => {
  ...
  if(this.state.potentionalClient !== [] && this.state.potentionalClient.bills !== undefined){

    axios.put('https://desk-clients.firebaseio.com/potentional-clients/'  + this.state.potentionalClient.id + '.json?auth=' + this.props.isAuth, {
      ...this.state.potentionalClient,
      oib: this.state.billName ? this.state.billName : this.state.potentionalClient.oib,
      bills:[
       ...this.state.potentionalClient.bills,
        {
          ...
          projectInfo:{
            ...
            service: this.state.potentionalClient.offers[this.state.potentionalClient.offers.length-1].projectInfo.service !== '' ? this.state.potentionalClient.offers[this.state.potentionalClient.offers.length-1].projectInfo.service : null,
            projectStart: today
  ...
  } else if(this.state.potentionalClient !== [] && this.state.potentionalClient.bills === undefined){ // račun kreiran prvi puta kada se radi BES u cijelosti
    ...
    setTimeout(() => {
      ...
      for(let key in years){
       ...
       content: [
          ...
          },
          {
            ...
            table: {
              ...
              widths: [ 550 ],
              body: [
                  [ {text: 'Račun broj: ' + this.state.potentionalClient.offers[this.state.potentionalClient.offers.length-1].offerNum + '/' + realYear, alignment: 'center'}]
              ],
            },
            margin: [10, 30, 10, 10]
          },
          {
              ...
              table: {
                ...
                widths: [ 550 ],
                body: [
                    [ {text: 'Mjesto i nadnevak izdavanja: Zagreb, ' + today, alignment: 'left'}],
                    [ {text: 'Nadnevak isporuke: ' + today, alignment: 'left'}],
                    [ {text: 'Način plaćanja: uplata na žiro račun', alignment: 'left'}]
                ],
              },
              margin: [20, 18, 10, 0]
            },
            {
              ...
              table: {
                ...
                widths: [ 550 ],
                body: [
                    [ {text: 'KUPAC', alignment: 'left', bold: true}],
                    [ {text: 'Naziv: ' +  this.state.potentionalClient.companyName, alignment: 'left'}],
                    [ {text: 'Adresa: ' +  this.state.potentionalClient.companyAddress, alignment: 'left'}],
                    [ {text: 'OIB: ' + this.state.potentionalClient.oib, alignment: 'left'}]
                ],
              },
              margin: [20, 10, 10, 0]
            },
            ...
            },
          {
            ...
            table: {
              ...
              widths: [ 30, 30, 160, 45, 115, 115 ],
              body: [
                  [ { text: 'Rbr.', style: 'headerStyle'} , { text: 'Šifra', style: 'headerStyle'}, { text: 'Naziv usluge', style: 'headerStyle'}, { text: 'Količina', style: 'headerStyle'}, 
                  
                  { text: 'Pojedinačna cijena', style: 'headerStyle'}, { text: 'Ukupno', style: 'headerStyle'} ],

                  [ 
                    
                    {text: '1.', margin: [0,5,0,0]}, '', {text: 'Business Expand System', margin: [0,5,0,0]}, 

                    {text: '1', margin: [0,5,0,0]}, 

                    {text: new Intl.NumberFormat('de-DE', { style: 'currency', currency: 'HRK' }).format(this.state.potentionalClient.offers[this.state.potentionalClient.offers.length-1].price) , margin: [0,5,0,0]}, 
          ...
          },
          {
            ...
            table: {
              ...
              widths: [230,320],
              body: [
                  [{text:'Slovima: ' + this.state.potentionalClient.bills[this.state.potentionalClient.bills.length-1].billPriceWords, alignment: 'left'},''],
                  [{text: 'Pod “Poziv na broj”, molimo, navedite OIB naručitelja. Pod opis, molimo navedite broj računa. Račun je izdan elektronskim putem i kao takav pravovaljan.', alignment: 'left'}, 
                  {svg: '<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 121.8 23.7" style="enable-background:new 0 0 121.8 23.7;" xml:space="preserve"><style type="text/css">.st0{fill:url(#SVGID_1_);}.st1{fill:url(#SVGID_2_);}.st2{fill:url(#SVGID_3_);}.st3{fill:url(#SVGID_4_);}.st4{fill:url(#SVGID_5_);}.st5{fill:url(#SVGID_6_);}.st6{fill:url(#SVGID_7_);}.st7{fill:url(#SVGID_8_);}.st8{fill:url(#SVGID_9_);}.st9{fill:url(#SVGID_10_);}</style><linearGradient id="SVGID_1_" radientUnits="userSpaceOnUse" x1="13.7904" y1="10.6906" x2="0.8567" y2="17.5676"><stop  offset="0" style="stop-color:#606994"/><stop  offset="1" style="stop-color:#1D3252"/></linearGradient><path class="st0" d="M12.4,20.2c-0.3,0-0.7,0.1-1.1,0.1c-2,0.2-3.9,0.5-5.9,0.6c-1.7,0.1-1.8,0-1.5-1.4C4.8,16,6.5,12.7,7.7,9.2 c0.7-1.9,1.7-3.7,2-5.7c0-0.2,0.2-0.5-0.2-0.6C9.1,2.8,9,3.1,9,3.3c-0.7,2.4-2,4.6-2.7,7c-1,3.3-2.8,6.4-3.5,9.7 c-0.3,1.4,0.1,1.9,2.1,2c2.4-0.2,4.9-0.5,7.5-0.8c0.6-0.1,1.5-0.1,1.5-0.6C13.8,20,12.9,20.3,12.4,20.2z"/><linearGradient id="SVGID_2_" gradientUnits="userSpaceOnUse" x1="69.5619" y1="9.8194" x2="57.2813" y2="16.3491"><stop  offset="0" style="stop-color:#606994"/><stop  offset="1" style="stop-color:#1D3252"/></linearGradient><path class="st1" d="M69.5,16.3c-1.3,1.7-2.9,2.9-4.8,4c-2.8,1.6-5.3-0.7-5.4-3.2c-0.1-5.3,1.9-9.6,6-13.2c0.6,0.9,0,1.9,0.2,3 c0.6-1.1,0.8-1.5,0.8-2.2c0-0.5,0.2-1.1-0.4-1.5c-0.6-0.3-1,0.1-1.5,0.4c-1.6,0.8-2.4,2.3-3.3,3.7c-2.2,3.1-2.8,6.7-2.6,10.3 c0.3,3.9,4.1,5.3,6.8,3.6c1.6-1,3.1-2.1,4.2-3.7c0.5-0.7,1.3-1.2,0.9-2.3C69.8,15.3,69.8,15.9,69.5,16.3z"/><linearGradient id="SVGID_3_" gradientUnits="userSpaceOnUse" x1="25.1991" y1="15.8916" x2="17.8053" y2="19.8229"><stop  offset="0" style="stop-color:#606994"/><stop  offset="1" style="stop-color:#1D3252"/></linearGradient><path class="st2" d="M25.4,20.9c-1.6,0.3-3.3,0.1-4.9-0.3c-2.1-0.5-2.9-2.5-2-4.4c0.6-1.2,1.3-2.5,2.6-3c0.5-0.2,1.1-0.6,1.7,0 c0.6,0.5,0.4,1.3,0,1.8c-0.8,1.2-1.5,2.6-3.2,2.8c-0.2,0-0.6,0.1-0.6,0.4c0,0.4,0.9,0.4,0.7,0.5c-0.1,0,1-0.1,1.4-0.5 c1.1-0.9,2.1-1.9,2.5-3.2c0.3-0.9,0.4-2-0.6-2.6c-0.9-0.6-2-0.4-2.7,0.2c-1.2,1-2.1,2.2-2.9,3.6c-0.7,1.3-0.6,2.3,0.3,3.4 c1.5,1.8,5.4,2.9,7.6,2c0.4-0.2,0.8-0.3,0.8-0.8C26,20.5,25.7,20.9,25.4,20.9z"/><linearGradient id="SVGID_4_" gradientUnits="userSpaceOnUse" x1="46.7696" y1="17.0783" x2="38.3797" y2="21.5392"><stop  offset="0" style="stop-color:#606994"/><stop  offset="1" style="stop-color:#1D3252"/></linearGradient><path class="st3" d="M44.4,16c-0.4,0.2-0.7,0.5-1.1,0.7c-1.3,0.9-2.2,2.5-3.7,3.1c-0.3,0.1-0.8,0.6-1.1,0.3c-0.3-0.3-0.1-1,0-1.3 c0.4-1,0.9-1.9,1.4-3c-1.5,0.4-2.8,3.4-2.2,4.6c0.4,0.8,1,1.1,1.9,0.5c1.2-0.8,2.3-1.8,3.3-2.9c0.6-0.6,1.6-1.8,2.5-1.4 c0.8,0.3,0.3,1.5,0.5,2.3c0.3,1,0,2.1,1,3c0.3-1.7-0.2-3.2-0.4-4.7C46.2,15.5,45.9,15.2,44.4,16z"/><linearGradient id="SVGID_5_" gradientUnits="userSpaceOnUse" x1="34.7086" y1="15.2591" x2="27.4378" y2="19.125"><stop  offset="0" style="stop-color:#606994"/><stop  offset="1" style="stop-color:#1D3252"/></linearGradient><path class="st4" d="M31.4,12.8c-1.3,0.2-1.9,1.2-2.1,2.3c-0.1,1.1-0.3,2-1.1,2.8c-0.7,0.9-0.4,1.9,0.1,2.9c0.3,0.6,0.6,1.2,1.5,1.2 c1.8,0,5-3.4,5.1-5.5c0-0.3-0.1-0.7-0.2-1.2C34.4,14.2,32.4,12.6,31.4,12.8z M34,16.4c-0.1,1.3-2.2,4-3.4,4.3 c-1,0.3-1.6-0.2-1.7-1.2c-0.1-0.6,0.3-1,0.5-1.6c0.2-0.6,0.7-1.1,0.6-2.3c0-0.8,0.2-1.6,1-2c0.7-0.4,1.3,0,1.7,0.6 C33.2,15,34.2,15.4,34,16.4z"/><linearGradient id="SVGID_6_" gradientUnits="userSpaceOnUse" x1="88.6487" y1="15.3226" x2="80.7244" y2="19.536"><stop  offset="0" style="stop-color:#606994"/><stop  offset="1" style="stop-color:#1D3252"/></linearGradient><path class="st5" d="M86.5,14.6c-0.2,0.1-0.4,0.5-0.6,0.7c-0.7,1-1.9,2.8-2.8,4c-0.1-1.3,0.6-3.1,0-4.4c-0.6,2.2-1,4-1.2,6 c-0.1,0.4-0.2,1,0.4,1.1c0.5,0.1,0.6-0.4,0.8-0.7c0.9-1.8,2-3.5,3.3-5.1c1.1-1.4,1.3-1.3,1.9,0.4c0.3-0.9,0.6-1.2-0.2-1.9 C87.3,13.9,87.2,14,86.5,14.6z"/><linearGradient id="SVGID_7_" gradientUnits="userSpaceOnUse" x1="80.3337" y1="15.8113" x2="73.1748" y2="19.6177"><stop  offset="0" style="stop-color:#606994"/><stop  offset="1" style="stop-color:#1D3252"/></linearGradient><path class="st6" d="M79.3,15.6c-0.5,0.6-0.8,1.2-1.2,1.9c-0.8,1.1-1.6,2.5-3,3.3c0-1,0-2.1,0-2.9c0-0.8,0.2-1.7-0.3-2.5 c-0.4,1.7-1.3,3.3-0.7,5.2c0.2,0.6-0.2,1.4,0.5,1.5c0.6,0.1,1.2-0.3,1.6-0.8c1.4-1.6,2.7-3.3,3.7-5.2c0.1-0.2,0.4-0.4,0.1-0.7 C79.7,15.1,79.5,15.3,79.3,15.6z"/><linearGradient id="SVGID_8_" gradientUnits="userSpaceOnUse" x1="101.9075" y1="10.3646" x2="90.5161" y2="16.4215"><stop  offset="0" style="stop-color:#606994"/><stop  offset="1" style="stop-color:#1D3252"/></linearGradient><path class="st7" d="M98.8,13.1c-0.9-0.1-1.8-0.2-2.7-0.5c-0.8-0.3-1.1-0.7-0.8-1.4C96.1,8.5,96.4,5.7,98,3c-1,0.2-1,0.7-1.3,1.2 c-1.3,2-1.5,4.3-2,6.5c-0.3,1.1-0.7,1.1-1.6,0.3c-0.9-0.7-1.5-0.5-1.8,0.5c-0.2,0.6,0,1.2-0.2,1.8c-0.3,1,1,1.6,1.8,2.4 c0.8,0.8,0.4,1,0.2,1.8c-0.3,1.2-0.4,2.4,0.1,3.6c0.2,0.4,0.1,0.9,0.7,0.8c0.6,0,0.8-0.5,0.9-0.9c0.1-0.4,0.3-0.8-0.2-1.1 c-0.6,0-0.3,0.6-0.9,0.7c-0.4-2.4,0.2-4.6,0.8-6.8c0.2-0.7,1.1-0.6,1.6-0.5c0.9,0.3,2,0.1,2.7,0.9c0,0,0.1,0.3,0.1,0.3 c-0.4,1.8-0.1,3.7-0.8,5.4c-0.1,0.3-0.1,0.7-0.1,1.1c0,0.3-0.1,0.6,0.2,0.6c0.4,0,0.4-0.3,0.4-0.6c0.4-2.3,0.8-4.6,1.2-6.9 C100.1,13.5,99.7,13.1,98.8,13.1z M92.7,14.7c-0.6,0-1.2-0.6-1.2-1.4c-0.1-0.8,0.4-1.5,1-1.5c0.6,0,1.2,0.6,1.2,1.4 C93.7,14,93.3,14.7,92.7,14.7z"/><linearGradient id="SVGID_9_" gradientUnits="userSpaceOnUse" x1="100.6645" y1="10.0244" x2="99.2786" y2="10.7613"><stop  offset="0" style="stop-color:#606994"/><stop  offset="1" style="stop-color:#1D3252"/></linearGradient><path class="st8" d="M99.1,10.4c0,0,0.3,0.4,0.5,0.4c0.2,0,1.3-0.4,1.3-0.4s-0.8-0.2-1-0.2S99.1,10.4,99.1,10.4z"/><linearGradient id="SVGID_10_" gradientUnits="userSpaceOnUse" x1="114.4905" y1="12.1614" x2="102.7737" y2="18.3913"><stop  offset="0" style="stop-color:#606994"/><stop  offset="1" style="stop-color:#1D3252"/></linearGradient><path class="st9" d="M117.1,19.4c-1.5-1-2.5-1.9-3.8-3.1c-0.3-0.3-0.4-0.7-1-0.5c-0.5,0.3-0.4,0.6-0.3,1c0.1,1.5-0.8,2.6-1.7,3.5	c-0.3,0.3-0.6,0.6-1,0.2c-0.3-0.4-0.2-0.8,0.1-1.2c0.3-0.4,0.6-0.8,0.9-1.3c0.3-0.5,0.4-1.1-0.1-1.6c-0.6-0.5-1.1,0-1.5,0.4	c-0.6,0.6-0.9,1.4-1.1,2.3c-0.2,1.2-1.1,1.3-1.9,1.5c-0.5,0.1-1-0.2-1.1-0.8c-0.2-1.5-0.9-3.1-0.5-4.6c1.1-4.4,1.5-9.1,5.3-12.3	c-1.9,0.3-3,1.7-3.6,3.4c-0.9,2.4-1.7,4.8-2.2,7.2c-0.5,2.1-0.5,4.3,0.2,6.4c0.5,1.6,1.4,2.1,2.8,1.5c0.8-0.3,1.4-0.5,2.2,0.1 c0.7,0.6,1.4,0.3,2.1-0.3c0.6-0.6,0.9-1.3,1.3-2c0.9-1.7,1.3-1.9,2.8-0.7c1.7,1.4,2.8,2.3,4.7,3.2C118.8,20.6,118.1,20,117.1,19.4z M108.4,19.5c-0.1-0.1,0.2-1.7,0.5-2c0.3-0.4,0.7-0.4,0.8-0.3c0.1,0.1,0.2,0.6-0.1,0.9C109.3,18.4,108.5,19.6,108.4,19.5z"/></svg>',
              width: 150}
            ]
              ],
       ...
       pdfMake.createPdf(docDefinition).download('Račun.pdf');
}, 500); 
      

    }

    billAllDownloadHandler = (e, billNum, price, companyName, companyAddress, date, billPriceWords, oib) => {
       ...
       content: [
          ...
          },
          {
            ...
            table: {
              ...
              widths: [ 550 ],
              body: [
                  [ {text: 'Račun broj: ' + billNum + '/' + realYear, alignment: 'center'}]
              ],
            },
            margin: [10, 30, 10, 10]
          },
          {
              ...
              table: {
                ...
                widths: [ 550 ],
                body: [
                    [ {text: 'Mjesto i nadnevak izdavanja: Zagreb, ' + date, alignment: 'left'}],
                    [ {text: 'Nadnevak isporuke: ' + date, alignment: 'left'}],
                    [ {text: 'Način plaćanja: uplata na žiro račun', alignment: 'left'}]
                ],
              },
              margin: [20, 18, 10, 0]
            },
            {
              ...
              table: {
                ...
                body: [
                    [ {text: 'KUPAC', alignment: 'left', bold: true}],
                    [ {text: 'Naziv: ' +  companyName, alignment: 'left'}],
                    [ {text: 'Adresa: ' +  companyAddress, alignment: 'left'}],
                    [ {text: 'OIB: ' + oib, alignment: 'left'}]
                ],
              },
              margin: [20, 10, 10, 0]
            },
            ...
            },
          {
            ...
            table: {
              ...
              body: [
                  ...
                  { text: 'Pojedinačna cijena', style: 'headerStyle', margin: [2, 2],}, { text: 'Ukupno', style: 'headerStyle'} ],

                  [ {text: '1.', margin: [0, 5,0,0,]}, '', {text: 'Business Expand System', margin: [0, 5,0,0,]}, {text: '1', margin: [0, 5,0,0,]}, {text: new Intl.NumberFormat('de-DE', { style: 'currency', currency: 'HRK' }).format(price), margin: [0, 5,0,0,]}, {text: new Intl.NumberFormat('de-DE', { style: 'currency', currency: 'HRK' }).format(price), margin: [0, 5,0,0,]}]
              ],
            },
            margin: [10, 20, 10, 20]
          },
          {
            ...
            table: {
              ...
              body: [
                  [''],
                  [ {text: 'Oslobođeno plaćanja PDV-a prema čl.90.st.1. i st.2. Zakona o PDV-u.', style: 'pdv', margin: [3,2,0,0]}]
              ],
            },
            margin: [10, -15, 10, 20]
          },
          {
            ...
            table: {
              ...
              widths: [230,320],
              body: [
                  [{text:'Slovima: ' + billPriceWords, alignment: 'left'},''],
                  [{text: 'Pod “Poziv na broj”, molimo, navedite OIB naručitelja. Pod opis, molimo navedite broj računa. Račun je izdan elektronskim putem i kao takav pravovaljan.', alignment: 'left'}, 
                  {svg: '<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 121.8 23.7" style="enable-background:new 0 0 121.8 23.7;" xml:space="preserve"><style type="text/css">.st0{fill:url(#SVGID_1_);}.st1{fill:url(#SVGID_2_);}.st2{fill:url(#SVGID_3_);}.st3{fill:url(#SVGID_4_);}.st4{fill:url(#SVGID_5_);}.st5{fill:url(#SVGID_6_);}.st6{fill:url(#SVGID_7_);}.st7{fill:url(#SVGID_8_);}.st8{fill:url(#SVGID_9_);}.st9{fill:url(#SVGID_10_);}</style><linearGradient id="SVGID_1_" radientUnits="userSpaceOnUse" x1="13.7904" y1="10.6906" x2="0.8567" y2="17.5676"><stop  offset="0" style="stop-color:#606994"/><stop  offset="1" style="stop-color:#1D3252"/></linearGradient><path class="st0" d="M12.4,20.2c-0.3,0-0.7,0.1-1.1,0.1c-2,0.2-3.9,0.5-5.9,0.6c-1.7,0.1-1.8,0-1.5-1.4C4.8,16,6.5,12.7,7.7,9.2 c0.7-1.9,1.7-3.7,2-5.7c0-0.2,0.2-0.5-0.2-0.6C9.1,2.8,9,3.1,9,3.3c-0.7,2.4-2,4.6-2.7,7c-1,3.3-2.8,6.4-3.5,9.7 c-0.3,1.4,0.1,1.9,2.1,2c2.4-0.2,4.9-0.5,7.5-0.8c0.6-0.1,1.5-0.1,1.5-0.6C13.8,20,12.9,20.3,12.4,20.2z"/><linearGradient id="SVGID_2_" gradientUnits="userSpaceOnUse" x1="69.5619" y1="9.8194" x2="57.2813" y2="16.3491"><stop  offset="0" style="stop-color:#606994"/><stop  offset="1" style="stop-color:#1D3252"/></linearGradient><path class="st1" d="M69.5,16.3c-1.3,1.7-2.9,2.9-4.8,4c-2.8,1.6-5.3-0.7-5.4-3.2c-0.1-5.3,1.9-9.6,6-13.2c0.6,0.9,0,1.9,0.2,3 c0.6-1.1,0.8-1.5,0.8-2.2c0-0.5,0.2-1.1-0.4-1.5c-0.6-0.3-1,0.1-1.5,0.4c-1.6,0.8-2.4,2.3-3.3,3.7c-2.2,3.1-2.8,6.7-2.6,10.3 c0.3,3.9,4.1,5.3,6.8,3.6c1.6-1,3.1-2.1,4.2-3.7c0.5-0.7,1.3-1.2,0.9-2.3C69.8,15.3,69.8,15.9,69.5,16.3z"/><linearGradient id="SVGID_3_" gradientUnits="userSpaceOnUse" x1="25.1991" y1="15.8916" x2="17.8053" y2="19.8229"><stop  offset="0" style="stop-color:#606994"/><stop  offset="1" style="stop-color:#1D3252"/></linearGradient><path class="st2" d="M25.4,20.9c-1.6,0.3-3.3,0.1-4.9-0.3c-2.1-0.5-2.9-2.5-2-4.4c0.6-1.2,1.3-2.5,2.6-3c0.5-0.2,1.1-0.6,1.7,0 c0.6,0.5,0.4,1.3,0,1.8c-0.8,1.2-1.5,2.6-3.2,2.8c-0.2,0-0.6,0.1-0.6,0.4c0,0.4,0.9,0.4,0.7,0.5c-0.1,0,1-0.1,1.4-0.5 c1.1-0.9,2.1-1.9,2.5-3.2c0.3-0.9,0.4-2-0.6-2.6c-0.9-0.6-2-0.4-2.7,0.2c-1.2,1-2.1,2.2-2.9,3.6c-0.7,1.3-0.6,2.3,0.3,3.4 c1.5,1.8,5.4,2.9,7.6,2c0.4-0.2,0.8-0.3,0.8-0.8C26,20.5,25.7,20.9,25.4,20.9z"/><linearGradient id="SVGID_4_" gradientUnits="userSpaceOnUse" x1="46.7696" y1="17.0783" x2="38.3797" y2="21.5392"><stop  offset="0" style="stop-color:#606994"/><stop  offset="1" style="stop-color:#1D3252"/></linearGradient><path class="st3" d="M44.4,16c-0.4,0.2-0.7,0.5-1.1,0.7c-1.3,0.9-2.2,2.5-3.7,3.1c-0.3,0.1-0.8,0.6-1.1,0.3c-0.3-0.3-0.1-1,0-1.3 c0.4-1,0.9-1.9,1.4-3c-1.5,0.4-2.8,3.4-2.2,4.6c0.4,0.8,1,1.1,1.9,0.5c1.2-0.8,2.3-1.8,3.3-2.9c0.6-0.6,1.6-1.8,2.5-1.4 c0.8,0.3,0.3,1.5,0.5,2.3c0.3,1,0,2.1,1,3c0.3-1.7-0.2-3.2-0.4-4.7C46.2,15.5,45.9,15.2,44.4,16z"/><linearGradient id="SVGID_5_" gradientUnits="userSpaceOnUse" x1="34.7086" y1="15.2591" x2="27.4378" y2="19.125"><stop  offset="0" style="stop-color:#606994"/><stop  offset="1" style="stop-color:#1D3252"/></linearGradient><path class="st4" d="M31.4,12.8c-1.3,0.2-1.9,1.2-2.1,2.3c-0.1,1.1-0.3,2-1.1,2.8c-0.7,0.9-0.4,1.9,0.1,2.9c0.3,0.6,0.6,1.2,1.5,1.2 c1.8,0,5-3.4,5.1-5.5c0-0.3-0.1-0.7-0.2-1.2C34.4,14.2,32.4,12.6,31.4,12.8z M34,16.4c-0.1,1.3-2.2,4-3.4,4.3 c-1,0.3-1.6-0.2-1.7-1.2c-0.1-0.6,0.3-1,0.5-1.6c0.2-0.6,0.7-1.1,0.6-2.3c0-0.8,0.2-1.6,1-2c0.7-0.4,1.3,0,1.7,0.6 C33.2,15,34.2,15.4,34,16.4z"/><linearGradient id="SVGID_6_" gradientUnits="userSpaceOnUse" x1="88.6487" y1="15.3226" x2="80.7244" y2="19.536"><stop  offset="0" style="stop-color:#606994"/><stop  offset="1" style="stop-color:#1D3252"/></linearGradient><path class="st5" d="M86.5,14.6c-0.2,0.1-0.4,0.5-0.6,0.7c-0.7,1-1.9,2.8-2.8,4c-0.1-1.3,0.6-3.1,0-4.4c-0.6,2.2-1,4-1.2,6 c-0.1,0.4-0.2,1,0.4,1.1c0.5,0.1,0.6-0.4,0.8-0.7c0.9-1.8,2-3.5,3.3-5.1c1.1-1.4,1.3-1.3,1.9,0.4c0.3-0.9,0.6-1.2-0.2-1.9 C87.3,13.9,87.2,14,86.5,14.6z"/><linearGradient id="SVGID_7_" gradientUnits="userSpaceOnUse" x1="80.3337" y1="15.8113" x2="73.1748" y2="19.6177"><stop  offset="0" style="stop-color:#606994"/><stop  offset="1" style="stop-color:#1D3252"/></linearGradient><path class="st6" d="M79.3,15.6c-0.5,0.6-0.8,1.2-1.2,1.9c-0.8,1.1-1.6,2.5-3,3.3c0-1,0-2.1,0-2.9c0-0.8,0.2-1.7-0.3-2.5 c-0.4,1.7-1.3,3.3-0.7,5.2c0.2,0.6-0.2,1.4,0.5,1.5c0.6,0.1,1.2-0.3,1.6-0.8c1.4-1.6,2.7-3.3,3.7-5.2c0.1-0.2,0.4-0.4,0.1-0.7 C79.7,15.1,79.5,15.3,79.3,15.6z"/><linearGradient id="SVGID_8_" gradientUnits="userSpaceOnUse" x1="101.9075" y1="10.3646" x2="90.5161" y2="16.4215"><stop  offset="0" style="stop-color:#606994"/><stop  offset="1" style="stop-color:#1D3252"/></linearGradient><path class="st7" d="M98.8,13.1c-0.9-0.1-1.8-0.2-2.7-0.5c-0.8-0.3-1.1-0.7-0.8-1.4C96.1,8.5,96.4,5.7,98,3c-1,0.2-1,0.7-1.3,1.2 c-1.3,2-1.5,4.3-2,6.5c-0.3,1.1-0.7,1.1-1.6,0.3c-0.9-0.7-1.5-0.5-1.8,0.5c-0.2,0.6,0,1.2-0.2,1.8c-0.3,1,1,1.6,1.8,2.4 c0.8,0.8,0.4,1,0.2,1.8c-0.3,1.2-0.4,2.4,0.1,3.6c0.2,0.4,0.1,0.9,0.7,0.8c0.6,0,0.8-0.5,0.9-0.9c0.1-0.4,0.3-0.8-0.2-1.1 c-0.6,0-0.3,0.6-0.9,0.7c-0.4-2.4,0.2-4.6,0.8-6.8c0.2-0.7,1.1-0.6,1.6-0.5c0.9,0.3,2,0.1,2.7,0.9c0,0,0.1,0.3,0.1,0.3 c-0.4,1.8-0.1,3.7-0.8,5.4c-0.1,0.3-0.1,0.7-0.1,1.1c0,0.3-0.1,0.6,0.2,0.6c0.4,0,0.4-0.3,0.4-0.6c0.4-2.3,0.8-4.6,1.2-6.9 C100.1,13.5,99.7,13.1,98.8,13.1z M92.7,14.7c-0.6,0-1.2-0.6-1.2-1.4c-0.1-0.8,0.4-1.5,1-1.5c0.6,0,1.2,0.6,1.2,1.4 C93.7,14,93.3,14.7,92.7,14.7z"/><linearGradient id="SVGID_9_" gradientUnits="userSpaceOnUse" x1="100.6645" y1="10.0244" x2="99.2786" y2="10.7613"><stop  offset="0" style="stop-color:#606994"/><stop  offset="1" style="stop-color:#1D3252"/></linearGradient><path class="st8" d="M99.1,10.4c0,0,0.3,0.4,0.5,0.4c0.2,0,1.3-0.4,1.3-0.4s-0.8-0.2-1-0.2S99.1,10.4,99.1,10.4z"/><linearGradient id="SVGID_10_" gradientUnits="userSpaceOnUse" x1="114.4905" y1="12.1614" x2="102.7737" y2="18.3913"><stop  offset="0" style="stop-color:#606994"/><stop  offset="1" style="stop-color:#1D3252"/></linearGradient><path class="st9" d="M117.1,19.4c-1.5-1-2.5-1.9-3.8-3.1c-0.3-0.3-0.4-0.7-1-0.5c-0.5,0.3-0.4,0.6-0.3,1c0.1,1.5-0.8,2.6-1.7,3.5	c-0.3,0.3-0.6,0.6-1,0.2c-0.3-0.4-0.2-0.8,0.1-1.2c0.3-0.4,0.6-0.8,0.9-1.3c0.3-0.5,0.4-1.1-0.1-1.6c-0.6-0.5-1.1,0-1.5,0.4	c-0.6,0.6-0.9,1.4-1.1,2.3c-0.2,1.2-1.1,1.3-1.9,1.5c-0.5,0.1-1-0.2-1.1-0.8c-0.2-1.5-0.9-3.1-0.5-4.6c1.1-4.4,1.5-9.1,5.3-12.3	c-1.9,0.3-3,1.7-3.6,3.4c-0.9,2.4-1.7,4.8-2.2,7.2c-0.5,2.1-0.5,4.3,0.2,6.4c0.5,1.6,1.4,2.1,2.8,1.5c0.8-0.3,1.4-0.5,2.2,0.1 c0.7,0.6,1.4,0.3,2.1-0.3c0.6-0.6,0.9-1.3,1.3-2c0.9-1.7,1.3-1.9,2.8-0.7c1.7,1.4,2.8,2.3,4.7,3.2C118.8,20.6,118.1,20,117.1,19.4z M108.4,19.5c-0.1-0.1,0.2-1.7,0.5-2c0.3-0.4,0.7-0.4,0.8-0.3c0.1,0.1,0.2,0.6-0.1,0.9C109.3,18.4,108.5,19.6,108.4,19.5z"/></svg>',
              width: 150}
            ]
    ...
    sendHandler = () => { // kreiranje ponude
      ...
      if(
        ...
        (this.state.price !== '') &&
        (this.state.wordPrice !== '') &&
        (this.state.potentionalClient.companyName === undefined)
      ){
    ...
    expandBillHandler = (e,num) =>{

      let potentialClients = []

      for(let key in this.state.potentionalClients){
        if((key === num) && (this.state.potentionalClients[key].billsActive === false)){
        ...
        } else if((key === num) && (this.state.potentionalClients[key].billsActive === true)){
    ...
    serviceHandler = (e,id) => {
      ...
      if(!this.state.allServices[id].active){

        allServices.push({
          ...this.state.allServices,
          [id]:{
            ...this.state.allServices[id],
            active: true
          }
        })


        for(let key in allServices[0]){
          if(allServices[0][key].active){

            allServicesTrue.push(allServices[0][key])
        ...
        this.setState({
          allServices: Object.values(allServices[0]),
          //service: allServicesTrue.join(', ')
          service: allServicesTrue
        })


      }
        else if(this.state.allServices[id].active){
    ...
    allServicesInputHandler = () =>{

      this.setState(prevState => ({
        allServicesClick: !prevState.allServicesClick
      }))

    }

    technicalInfoHandler = (e,id, num) => {
  ...
  technicalInfoSendHandler = (e,id, num) => {


    if(this.state.potentionalClient.technicalInfo !== undefined){
      setTimeout(() => {
        ...
        technicalInfo: 
          {
            domena: ((this.state.potentionalClient.technicalInfo.domena !== undefined) || (this.state.potentionalClient.technicalInfo.domena !== '')) && (this.state.domena === '') ? this.state.potentionalClient.technicalInfo.domena : this.state.domena,

            webSiteUsername: ((this.state.potentionalClient.technicalInfo.webSiteUsername !== undefined) || (this.state.potentionalClient.technicalInfo.webSiteUsername !== '')) && (this.state.webSiteUsername === '') ? this.state.potentionalClient.technicalInfo.webSiteUsername : this.state.webSiteUsername,

            webSitePassword: ((this.state.potentionalClient.technicalInfo.webSitePassword !== undefined) || (this.state.potentionalClient.technicalInfo.webSitePassword !== '')) && (this.state.webSitePassword === '') ? this.state.potentionalClient.technicalInfo.webSitePassword : this.state.webSitePassword,

            cPanelUsername: ((this.state.potentionalClient.technicalInfo.cPanelUsername !== undefined) || (this.state.potentionalClient.technicalInfo.cPanelUsername !== '')) && (this.state.cPanelUsername === '') ? this.state.potentionalClient.technicalInfo.cPanelUsername : this.state.cPanelUsername,

            cPanelPassword: ((this.state.potentionalClient.technicalInfo.cPanelPassword !== undefined) || (this.state.potentionalClient.technicalInfo.cPanelPassword !== '')) && (this.state.cPanelPassword === '') ? this.state.potentionalClient.technicalInfo.cPanelPassword : this.state.cPanelPassword,

            emailUsername: ((this.state.potentionalClient.technicalInfo.emailUsername !== undefined) || (this.state.potentionalClient.technicalInfo.emailUsername !== '')) && (this.state.emailUsername === '') ? this.state.potentionalClient.technicalInfo.emailUsername : this.state.emailUsername,

            emailPassword: ((this.state.potentionalClient.technicalInfo.emailPassword !== undefined) || (this.state.potentionalClient.technicalInfo.emailPassword !== '')) && (this.state.emailPassword === '') ? this.state.potentionalClient.technicalInfo.emailPassword : this.state.emailPassword,

            firebaseUsername: ((this.state.potentionalClient.technicalInfo.firebaseUsername !== undefined) || (this.state.potentionalClient.technicalInfo.firebaseUsername !== '')) && (this.state.firebaseUsername === '') ? this.state.potentionalClient.technicalInfo.firebaseUsername : this.state.firebaseUsername,

            firebasePassword: ((this.state.potentionalClient.technicalInfo.firebasePassword !== undefined) || (this.state.potentionalClient.technicalInfo.firebasePassword !== '')) && (this.state.firebasePassword === '') ? this.state.potentionalClient.technicalInfo.firebasePassword : this.state.firebasePassword,

            appLink: ((this.state.potentionalClient.technicalInfo.appLink !== undefined) || (this.state.potentionalClient.technicalInfo.appLink !== '')) && (this.state.appLink === '') ? this.state.potentionalClient.technicalInfo.appLink : this.state.appLink,
            
            appUsername: ((this.state.potentionalClient.technicalInfo.appUsername !== undefined) || (this.state.potentionalClient.technicalInfo.appUsername !== '')) && (this.state.appUsername === '') ? this.state.potentionalClient.technicalInfo.appUsername : this.state.appUsername,

            appPassword: ((this.state.potentionalClient.technicalInfo.appPassword !== undefined) || (this.state.potentionalClient.technicalInfo.appPassword !== '')) && (this.state.appPassword === '') ? this.state.potentionalClient.technicalInfo.appPassword : this.state.appPassword,

            instagramLink: ((this.state.potentionalClient.technicalInfo.instagramLink !== undefined) || (this.state.potentionalClient.technicalInfo.instagramLink !== '')) && (this.state.instagramLink === '') ? this.state.potentionalClient.technicalInfo.instagramLink : this.state.instagramLink,

            facebookLink: ((this.state.potentionalClient.technicalInfo.facebookLink !== undefined) || (this.state.potentionalClient.technicalInfo.facebookLink !== '')) && (this.state.facebookLink === '') ? this.state.potentionalClient.technicalInfo.facebookLink : this.state.facebookLink,

            linkedIn: ((this.state.potentionalClient.technicalInfo.linkedIn !== undefined) || (this.state.potentionalClient.technicalInfo.linkedIn !== '')) && (this.state.linkedIn === '') ? this.state.potentionalClient.technicalInfo.linkedIn : this.state.linkedIn
          }
     ...
     setTimeout(() => {
      ...
      setTimeout(() => {
        ...
        technicalInfo: 
          {
            domena: this.state.domena ? this.state.domena : '',

            webSiteUsername: this.state.webSiteUsername ? this.state.webSiteUsername : '',
            webSitePassword: this.state.webSitePassword ? this.state.webSitePassword : '',

            cPanelUsername: this.state.cPanelUsername ? this.state.cPanelUsername : '',
            cPanelPassword: this.state.cPanelPassword ? this.state.cPanelPassword : '',

            emailUsername: this.state.emailUsername ? this.state.emailUsername : '',
            emailPassword: this.state.emailPassword ? this.state.emailPassword : '',

            firebaseUsername: this.state.firebaseUsername ? this.state.firebaseUsername : '',
            firebasePassword: this.state.firebasePassword ? this.state.firebasePassword : '',

            appLink: this.state.firebaseLink ? this.state.firebaseLink : '',
            appUsername: this.state.firebaseUsername ? this.state.firebaseUsername : '',
            appPassword: this.state.firebasePassword ? this.state.firebasePassword : '',

            instagramLink: this.state.instagramLink ? this.state.instagramLink : '',

            facebookLink: this.state.facebookLink ? this.state.facebookLink : '',
  ...
  startProjectHandler = (e, id, num) => {
    ...
    for(let key in this.state.potentionalClients){
      ...
      if(this.state.potentionalClient.bills.length === 1){ // za prvi kreirani račun
    ...
    setTimeout(() => {
      if (this.state.potentionalClient.bills.length > 1) { // za sve daljnje kreirane račune
           ...
           ...this.state.potentionalClient.bills,  
              ...
              [this.state.potentionalClient.bills.length-1]: {
                ...
                ...this.state.potentionalClient.bills[this.state.potentionalClient.bills.length-1],
                  ...
                  projectInfo: {
                    ...this.state.potentionalClient.bills[this.state.potentionalClient.bills.length-1].projectInfo,
                      projectStart: today
            }
    ...
    render(){ 
      ...
      for(let key in this.state.potentionalClients) {
        ...
        if(this.state.potentionalClients[key].shareTeam !== undefined && this.state.user.role === 'admin' && this.state.potentionalClients[key].check === true){
        ...
        } else if (this.state.user.role === 'superAdmin' && this.state.potentionalClients[key].check === true){
      ...
      if(this.state.searchValue !== ''){
        ...
        potentionalClients = clients.reverse()
      ...
      clientsMap = potentionalClients.map(p => (
            ...
            <div className="PotentialClient" key={p.name + p.surname + p.problem} style={{display: (p.potentional===false) && (p.delayDate!==true) && (p.check===true) ? 'block' : 'none'}}>

                <div className="PotentialClientBtns" style={{width: '80%'}}>

                    <div onClick={(e)=>this.billDownloadHandler(e,p.num)} style={{display: p.oib ? 'flex' : 'none', width: '18%', margin: '1%'}} >
                      <img src={download} />
                      <div>Skini Zadnji Račun</div>
                    </div>

                    <div onClick={(e)=>this.billHandler(e,p.id, p.num)} style={{width: '18%', margin: '1%', display: p.oib ? 'none' : 'flex'}}>
                      <img src={bill} />
                      <div>OIB Za Račun</div>
                    </div>

                    <div onClick={(e)=>this.billCreateHandler(e,p.id, p.num)} style={{width: '17%', margin: '1%', display: (p.oib !== undefined) && (p.offers.length > p.bills.length) ? 'flex' : 'none'}}>
                      <img src={bill} />
                      <div>Napravi Račun</div>
                    </div>
                    
                    <div onClick={(e)=>this.downloadOfferHandler(e,p.num)} style={{display: p.companyName ? 'flex' : 'none', width: '18%', margin: '1%'}} >
                      <img src={download} />
                      <div>Skini Zadnju Ponudu</div>
                    </div>

                    <div onClick={(e)=>this.offerHandler(e,p.id, p.num)} style={{width: '18%', margin: '1%'}}>
                      <img src={offer} />
                      <div>Napravi Ponudu</div>
                    </div>

                    <div onClick={(e)=>this.delayHandler(e,p.id, p.num)}  style={{width: '10%', margin: '1%'}}>
                      <img src={delay}/>
                      <div>Odgodi</div>
                    </div>

                    <div onClick={(e)=>this.deleteHandler(e,p.id, p.num)} style={{width: '10%', margin: '1%'}}>
                      <img src={deleteI}  />
                      <div>Obriši</div>
                    </div>
                ...
                <div className="PotentialClientWrapp">
                    ...
                    <div className="PotentialClientPart">
                        ...
                        <div className="PotentialClientPartBody"><h5>Naziv tvrtke:</h5><p>{p.companyName}</p></div>
                        ...
                        <div className="PotentialClientPartBody"><h5>Datum prijave:</h5><p>{p.day}</p></div>
                ...
                <div style={{display: 'flex'}}>
                  ...
                  <div className="PotentialClientBtn" onClick={(e)=>this.technicalInfoHandler(e,p.id, p.num)} style={{width: '15%'}}>
                    <img src={information} />
                    <div>Tehničke informacije</div>
                  </div>

                  {
                    (p.bills !== undefined) && ( p.bills[p.bills.length-1].projectInfo === undefined) ? 

                      <div className="PotentialClientBtn" onClick={(e)=>this.startProjectHandler(e,p.id, p.num)} 

                        style={{display: (p.bills !== undefined) && ( p.bills[p.bills.length-1].projectInfo === undefined), width: '15%', marginLeft: '2%'}}>

                        <img src={project} />
                        <div>Započni razvitak</div>
                ...
                <div className="PotentialClientOffersWrapp">
                  ...
                  {p.offers ?
                    p.offers.map(o =>(
                      <div key={o.offerNum+ o.price} className="PotentialClientOffers" style={{display: p.offersActive ? 'flex' : 'none'}}> 
                ...
                <div className="PotentialClientOffersWrapp" style={{marginTop: '1%'}}>
                  <div onClick={(e)=>this.expandBillHandler(e, p.num)} className="PotentialClientOffersExpand" style={{display: p.bills ? 'flex' : 'none'}}>
                    {p.billsActive ? <img src={minus} />: <img src={plus} />}<p>{p.billsActive ? ' Zatvori' : ' Pogledaj sve račune'}</p>
                  </div>
                  { p.bills ? 
                    p.bills.map(o =>(
                      <div key={o.offerNum+o.date+ o.price} className="PotentialClientOffers" style={{display: p.billsActive ? 'flex' : 'none'}}> 
                        <div className="PotentialClientOffersDiv"><h5>Datum:</h5> <p>{' ' + o.date}</p></div>
                        <div className="PotentialClientOffersDiv"><h5>Broj računa:</h5> <p>{' ' + o.billNum}</p></div>
                        <div className="PotentialClientOffersDiv"><h5>Cijena:</h5> <p>{' ' + new Intl.NumberFormat('de-DE', { style: 'currency', currency: 'HRK' }).format( o.price)}</p></div>
                        <div className="PotentialClientOffersBtn" onClick={(e)=>this.billAllDownloadHandler(e, o.billNum, o.price, p.companyName, p.companyAddress, o.date, o.billPriceWords, p.oib)}><img src={download} /><div>Skini račun</div></div>
                      </div>
                    ))
                    : null
                  }
        ...
        let heightModal1 = ((this.state.service === '') && (this.state.errorModal === true)) ? 30 : 0

        let heightModal2 = ((this.state.price === '') && (this.state.errorModal === true)) ? 30 : 0

        let heightModal3 = ((this.state.wordPrice === '') && (this.state.errorModal === true)) ? 60 : 0

        let heightModal4 = (this.state.allServicesClick === true) ? 300 : 0

        let rez = heightModal1 + heightModal2 + heightModal3 + heightModal4


        let domena = this.state.potentionalClient.technicalInfo !== undefined ? this.state.potentionalClient.technicalInfo.domena !== undefined ? this.state.potentionalClient.technicalInfo.domena : undefined : undefined

        let webSiteUsername = this.state.potentionalClient.technicalInfo !== undefined ? this.state.potentionalClient.technicalInfo.webSiteUsername !== undefined ? this.state.potentionalClient.technicalInfo.webSiteUsername : undefined : undefined

        let webSitePassword = this.state.potentionalClient.technicalInfo !== undefined ? this.state.potentionalClient.technicalInfo.webSitePassword !== undefined ? this.state.potentionalClient.technicalInfo.webSitePassword : undefined : undefined

        let cPanelUsername = this.state.potentionalClient.technicalInfo !== undefined ? this.state.potentionalClient.technicalInfo.cPanelUsername !== undefined ? this.state.potentionalClient.technicalInfo.cPanelUsername : undefined : undefined

        let cPanelPassword = this.state.potentionalClient.technicalInfo !== undefined ? this.state.potentionalClient.technicalInfo.cPanelPassword !== undefined ? this.state.potentionalClient.technicalInfo.cPanelPassword : undefined : undefined

        let emailUsername = this.state.potentionalClient.technicalInfo !== undefined ? this.state.potentionalClient.technicalInfo.emailUsername !== undefined ? this.state.potentionalClient.technicalInfo.emailUsername : undefined : undefined

        let emailPassword = this.state.potentionalClient.technicalInfo !== undefined ? this.state.potentionalClient.technicalInfo.emailPassword !== undefined ? this.state.potentionalClient.technicalInfo.emailPassword : undefined : undefined

        let firebaseUsername = this.state.potentionalClient.technicalInfo !== undefined ? this.state.potentionalClient.technicalInfo.firebaseUsername !== undefined ? this.state.potentionalClient.technicalInfo.firebaseUsername : undefined : undefined

        let firebasePassword = this.state.potentionalClient.technicalInfo !== undefined ? this.state.potentionalClient.technicalInfo.firebasePassword !== undefined ? this.state.potentionalClient.technicalInfo.firebasePassword : undefined : undefined

        let appLink = this.state.potentionalClient.technicalInfo !== undefined ? this.state.potentionalClient.technicalInfo.appLink !== undefined ? this.state.potentionalClient.technicalInfo.appLink : undefined : undefined

        let appUsername = this.state.potentionalClient.technicalInfo !== undefined ? this.state.potentionalClient.technicalInfo.appUsername !== undefined ? this.state.potentionalClient.technicalInfo.appUsername : undefined : undefined

        let appPassword = this.state.potentionalClient.technicalInfo !== undefined ? this.state.potentionalClient.technicalInfo.appPassword !== undefined ? this.state.potentionalClient.technicalInfo.appPassword : undefined : undefined

        let facebookLink = this.state.potentionalClient.technicalInfo !== undefined ? this.state.potentionalClient.technicalInfo.facebookLink !== undefined ? this.state.potentionalClient.technicalInfo.facebookLink : undefined : undefined

        let instagramLink = this.state.potentionalClient.technicalInfo !== undefined ? this.state.potentionalClient.technicalInfo.instagramLink !== undefined ? this.state.potentionalClient.technicalInfo.instagramLink : undefined : undefined

        let linkedIn = this.state.potentionalClient.technicalInfo !== undefined ? this.state.potentionalClient.technicalInfo.linkedIn !== undefined ? this.state.potentionalClient.technicalInfo.linkedIn : undefined : undefined
        ...
        return(
            <Aux>
                ...
                <div className="tehnicalInfoModal" style={{display: this.state.technicalInfoModal ? 'block' : 'none'}}>

                    <div onClick={this.tehnicalInfoCloseHandler}  className="PotentionalClientsModalBtn" style={{marginLeft: '13%'}}>
                      <img src={close} /> 
                      <div>Zatvori</div>
                    </div>

                    <div className="tehnicalInfoModalInputs">
                      ...
                      <div>
                        ...
                        <h5>Naziv domene:</h5>
                        {
                          domena !== undefined && domena !== '' ? 
                          
                          <div>
                            <input onChange={(e)=>this.changeHandler(e)} className="InputElement" name="domena" type="text" value={this.state.domena !== '' ? this.state.domena : domena} />
                            <div className="currentSituationDivError"  style={{display: (this.state.domena === '') && (this.state.errorModal === true) ? 'block' : 'none', marginLeft: 'auto', marginRight: 'auto', marginTop: '-1%'}}>⚠ Molim te ispuni polje</div>
                          </div>
                          
                          : 

                          <div>
                            <input onChange={(e)=>this.changeHandler(e)} className="InputElement" name="domena" type="text" value={this.state.domena} />
                            <div className="currentSituationDivError"  style={{display: (this.state.domena === '') && (this.state.errorModal === true) ? 'block' : 'none', marginLeft: 'auto', marginRight: 'auto', marginTop: '-1%'}}>⚠ Molim te ispuni polje</div>
                          </div>
                        }
                        ...
                        <h5>Wordpress korisničko ime:</h5>
                        {
                          webSiteUsername !== undefined && webSiteUsername !== ''  ? 

                          <div>
                          <input onChange={(e)=>this.changeHandler(e)} className="InputElement" name="webSiteUsername" type="text" value={this.state.webSiteUsername !== '' ? this.state.webSiteUsername : webSiteUsername} />
                          <div className="currentSituationDivError"  style={{display: (this.state.webSiteUsername === '') && (this.state.errorModal === true) ? 'block' : 'none', marginLeft: 'auto', marginRight: 'auto', marginTop: '-1%'}}>⚠ Molim te ispuni polje</div>
                        </div>
                        
                        : 

                        <div>
                          <input onChange={(e)=>this.changeHandler(e)} className="InputElement" name="webSiteUsername" type="text" value={this.state.webSiteUsername} />
                          <div className="currentSituationDivError"  style={{display: (this.state.webSiteUsername === '') && (this.state.errorModal === true) ? 'block' : 'none', marginLeft: 'auto', marginRight: 'auto', marginTop: '-1%'}}>⚠ Molim te ispuni polje</div>
                        </div>
                        }


                        <h5>Wordpress lozinka:</h5>

                        {
                          webSitePassword !== undefined && webSitePassword !== ''  ? 

                          <div>
                          <input onChange={(e)=>this.changeHandler(e)} className="InputElement" name="webSitePassword" type="text" value={this.state.webSitePassword !== '' ? this.state.webSitePassword : webSitePassword} />
                          <div className="currentSituationDivError"  style={{display: (this.state.webSitePassword === '') && (this.state.errorModal === true) ? 'block' : 'none', marginLeft: 'auto', marginRight: 'auto', marginTop: '-1%'}}>⚠ Molim te ispuni polje</div>
                        </div>
                        
                        : 

                        <div>
                          <input onChange={(e)=>this.changeHandler(e)} className="InputElement" name="webSitePassword" type="text" value={this.state.webSitePassword} />
                          <div className="currentSituationDivError"  style={{display: (this.state.webSitePassword === '') && (this.state.errorModal === true) ? 'block' : 'none', marginLeft: 'auto', marginRight: 'auto', marginTop: '-1%'}}>⚠ Molim te ispuni polje</div>
                        </div>
                        }

                        <h5>cPanel korisničko ime:</h5>

                        {
                          cPanelUsername !== undefined && cPanelUsername !== ''  ? 
                          
                          <div>
                          <input onChange={(e)=>this.changeHandler(e)} className="InputElement" name="cPanelUsername" type="text" value={this.state.cPanelUsername !== '' ? this.state.cPanelUsername : cPanelUsername} />
                          <div className="currentSituationDivError"  style={{display: (this.state.cPanelUsername === '') && (this.state.errorModal === true) ? 'block' : 'none', marginLeft: 'auto', marginRight: 'auto', marginTop: '-1%'}}>⚠ Molim te ispuni polje</div>
                        </div>
                        
                        : 

                        <div>
                          <input onChange={(e)=>this.changeHandler(e)} className="InputElement" name="cPanelUsername" type="text" value={this.state.cPanelUsername} />
                          <div className="currentSituationDivError"  style={{display: (this.state.cPanelUsername === '') && (this.state.errorModal === true) ? 'block' : 'none', marginLeft: 'auto', marginRight: 'auto', marginTop: '-1%'}}>⚠ Molim te ispuni polje</div>
                        </div>
                        ...
                        <h5>cPanel lozinka:</h5>

                        {
                          cPanelPassword !== undefined && cPanelPassword !== ''  ? 
                          
                          <div>
                          <input onChange={(e)=>this.changeHandler(e)} className="InputElement" name="cPanelPassword" type="text" value={this.state.cPanelPassword !== '' ? this.state.cPanelPassword : cPanelPassword} />
                          <div className="currentSituationDivError"  style={{display: (this.state.cPanelPassword === '') && (this.state.errorModal === true) ? 'block' : 'none', marginLeft: 'auto', marginRight: 'auto', marginTop: '-1%'}}>⚠ Molim te ispuni polje</div>
                        </div>
                        
                        : 

                        <div>
                          <input onChange={(e)=>this.changeHandler(e)} className="InputElement" name="cPanelPassword" type="text" value={this.state.cPanelPassword} />
                          <div className="currentSituationDivError"  style={{display: (this.state.cPanelPassword === '') && (this.state.errorModal === true) ? 'block' : 'none', marginLeft: 'auto', marginRight: 'auto', marginTop: '-1%'}}>⚠ Molim te ispuni polje</div>
                        </div>

                        }

                        <h5>Email korisničko ime:</h5>

                        {
                          emailUsername !== undefined && emailUsername !== ''  ? 
                          
                          <div>
                          <input onChange={(e)=>this.changeHandler(e)} className="InputElement" name="emailUsername" type="text" value={this.state.emailUsername !== '' ? this.state.emailUsername : emailUsername} />
                          <div className="currentSituationDivError"  style={{display: (this.state.emailUsername === '') && (this.state.errorModal === true) ? 'block' : 'none', marginLeft: 'auto', marginRight: 'auto', marginTop: '-1%'}}>⚠ Molim te ispuni polje</div>
                        </div>
                        
                        : 

                        <div>
                          <input onChange={(e)=>this.changeHandler(e)} className="InputElement" name="emailUsername" type="text" value={this.state.emailUsername} />
                          <div className="currentSituationDivError"  style={{display: (this.state.emailUsername === '') && (this.state.errorModal === true) ? 'block' : 'none', marginLeft: 'auto', marginRight: 'auto', marginTop: '-1%'}}>⚠ Molim te ispuni polje</div>
                        </div>
                       ...
                       
                        {
                          ...
                          <div>
                          <input onChange={(e)=>this.changeHandler(e)} className="InputElement" name="emailPassword" type="text" value={this.state.emailPassword !== '' ? this.state.emailPassword : emailPassword} />
                          <div className="currentSituationDivError"  style={{display: (this.state.emailPassword === '') && (this.state.errorModal === true) ? 'block' : 'none', marginLeft: 'auto', marginRight: 'auto', marginTop: '-1%'}}>⚠ Molim te ispuni polje</div>
                        </div>
                        
                        : 

                        <div>
                          <input onChange={(e)=>this.changeHandler(e)} className="InputElement" name="emailPassword" type="text" value={this.state.emailPassword} />
                          <div className="currentSituationDivError"  style={{display: (this.state.emailPassword === '') && (this.state.errorModal === true) ? 'block' : 'none', marginLeft: 'auto', marginRight: 'auto', marginTop: '-1%'}}>⚠ Molim te ispuni polje</div>
                        </div>
                      ...
                      <div>
                        ...
                        <h5>Firebase korisničko ime:</h5>

                        {
                          firebaseUsername !== undefined && firebaseUsername !== ''  ? 
                          
                          <div>
                          <input onChange={(e)=>this.changeHandler(e)} className="InputElement" name="firebaseUsername" type="text" value={this.state.firebaseUsername !== '' ? this.state.firebaseUsername : firebaseUsername} />
                          <div className="currentSituationDivError"  style={{display: (this.state.firebaseUsername === '') && (this.state.errorModal === true) ? 'block' : 'none', marginLeft: 'auto', marginRight: 'auto', marginTop: '-1%'}}>⚠ Molim te ispuni polje</div>
                        </div>
                        
                        : 

                        <div>
                          <input onChange={(e)=>this.changeHandler(e)} className="InputElement" name="firebaseUsername" type="text" value={this.state.firebaseUsername} />
                          <div className="currentSituationDivError"  style={{display: (this.state.firebaseUsername === '') && (this.state.errorModal === true) ? 'block' : 'none', marginLeft: 'auto', marginRight: 'auto', marginTop: '-1%'}}>⚠ Molim te ispuni polje</div>
                        </div>

                        }

                        <h5>Firebase lozinka:</h5>

                        {
                          firebasePassword !== undefined && firebasePassword !== ''  ? 
                          
                          <div>
                          <input onChange={(e)=>this.changeHandler(e)} className="InputElement" name="firebasePassword" type="text" value={this.state.firebasePassword !== '' ? this.state.firebasePassword : firebasePassword} />
                          <div className="currentSituationDivError"  style={{display: (this.state.firebasePassword === '') && (this.state.errorModal === true) ? 'block' : 'none', marginLeft: 'auto', marginRight: 'auto', marginTop: '-1%'}}>⚠ Molim te ispuni polje</div>
                        </div>
                        
                        : 

                        <div>
                          <input onChange={(e)=>this.changeHandler(e)} className="InputElement" name="firebasePassword" type="text" value={this.state.firebasePassword} />
                          <div className="currentSituationDivError"  style={{display: (this.state.firebasePassword === '') && (this.state.errorModal === true) ? 'block' : 'none', marginLeft: 'auto', marginRight: 'auto', marginTop: '-1%'}}>⚠ Molim te ispuni polje</div>
                        </div>
...

                        {
                          ...
                          <div>
                          <input onChange={(e)=>this.changeHandler(e)} className="InputElement" name="appLink" type="text" value={this.state.appLink !== '' ? this.state.appLink : appLink} />
                          <div className="currentSituationDivError"  style={{display: (this.state.appLink === '') && (this.state.errorModal === true) ? 'block' : 'none', marginLeft: 'auto', marginRight: 'auto', marginTop: '-1%'}}>⚠ Molim te ispuni polje</div>
                        </div>
                        
                        : 

                        <div>
                          <input onChange={(e)=>this.changeHandler(e)} className="InputElement" name="appLink" type="text" value={this.state.appLink} />
                          <div className="currentSituationDivError"  style={{display: (this.state.appLink === '') && (this.state.errorModal === true) ? 'block' : 'none', marginLeft: 'auto', marginRight: 'auto', marginTop: '-1%'}}>⚠ Molim te ispuni polje</div>
                        </div>

                        }

                        <h5>App korisničko ime:</h5>

                        {
                          appUsername !== undefined && appUsername !== ''  ? 
                          
                          <div>
                          <input onChange={(e)=>this.changeHandler(e)} className="InputElement" name="appUsername" type="text" value={this.state.appUsername !== '' ? this.state.appUsername : appUsername} />
                          <div className="currentSituationDivError"  style={{display: (this.state.appUsername === '') && (this.state.errorModal === true) ? 'block' : 'none', marginLeft: 'auto', marginRight: 'auto', marginTop: '-1%'}}>⚠ Molim te ispuni polje</div>
                        </div>
                        
                        : 

                        <div>
                          <input onChange={(e)=>this.changeHandler(e)} className="InputElement" name="appUsername" type="text" value={this.state.appUsername} />
                          <div className="currentSituationDivError"  style={{display: (this.state.appUsername === '') && (this.state.errorModal === true) ? 'block' : 'none', marginLeft: 'auto', marginRight: 'auto', marginTop: '-1%'}}>⚠ Molim te ispuni polje</div>
                        </div>
...

                        {
                          ...
                          <div>
                          <input onChange={(e)=>this.changeHandler(e)} className="InputElement" name="appPassword" type="text" value={this.state.appPassword !== '' ? this.state.appPassword : appPassword} />
                          <div className="currentSituationDivError"  style={{display: (this.state.appPassword === '') && (this.state.errorModal === true) ? 'block' : 'none', marginLeft: 'auto', marginRight: 'auto', marginTop: '-1%'}}>⚠ Molim te ispuni polje</div>
                        </div>
                        
                        : 

                        <div>
                          <input onChange={(e)=>this.changeHandler(e)} className="InputElement" name="appPassword" type="text" value={this.state.appPassword} />
                          <div className="currentSituationDivError"  style={{display: (this.state.appPassword === '') && (this.state.errorModal === true) ? 'block' : 'none', marginLeft: 'auto', marginRight: 'auto', marginTop: '-1%'}}>⚠ Molim te ispuni polje</div>
                        </div>
...

                        {
                          ...
                          <div>
                          <input onChange={(e)=>this.changeHandler(e)} className="InputElement" name="instagramLink" type="text" value={this.state.instagramLink !== '' ? this.state.instagramLink : instagramLink} />
                          <div className="currentSituationDivError"  style={{display: (this.state.instagramLink === '') && (this.state.errorModal === true) ? 'block' : 'none', marginLeft: 'auto', marginRight: 'auto', marginTop: '-1%'}}>⚠ Molim te ispuni polje</div>
                        </div>
                        
                        : 

                        <div>
                          <input onChange={(e)=>this.changeHandler(e)} className="InputElement" name="instagramLink" type="text" value={this.state.instagramLink} />
                          <div className="currentSituationDivError"  style={{display: (this.state.instagramLink === '') && (this.state.errorModal === true) ? 'block' : 'none', marginLeft: 'auto', marginRight: 'auto', marginTop: '-1%'}}>⚠ Molim te ispuni polje</div>
                        </div>
...

                        {
                          ...
                          <div>
                          <input onChange={(e)=>this.changeHandler(e)} className="InputElement" name="facebookLink" type="text" value={this.state.facebookLink !== '' ? this.state.facebookLink : facebookLink} />
                          <div className="currentSituationDivError"  style={{display: (this.state.facebookLink === '') && (this.state.errorModal === true) ? 'block' : 'none', marginLeft: 'auto', marginRight: 'auto', marginTop: '-1%'}}>⚠ Molim te ispuni polje</div>
                        </div>
                        
                        : 

                        <div>
                          <input onChange={(e)=>this.changeHandler(e)} className="InputElement" name="facebookLink" type="text" value={this.state.facebookLink} />
                          <div className="currentSituationDivError"  style={{display: (this.state.facebookLink === '') && (this.state.errorModal === true) ? 'block' : 'none', marginLeft: 'auto', marginRight: 'auto', marginTop: '-1%'}}>⚠ Molim te ispuni polje</div>
                        </div>
...

                        {
                          ...
                          <div>
                          <input onChange={(e)=>this.changeHandler(e)} className="InputElement" name="linkedIn" type="text" value={this.state.linkedIn !== '' ? this.state.linkedIn : linkedIn} />
                          <div className="currentSituationDivError"  style={{display: (this.state.linkedIn === '') && (this.state.errorModal === true) ? 'block' : 'none', marginLeft: 'auto', marginRight: 'auto', marginTop: '-1%'}}>⚠ Molim te ispuni polje</div>
                        </div>
                        
                        : 

                        <div>
                          <input onChange={(e)=>this.changeHandler(e)} className="InputElement" name="linkedIn" type="text" value={this.state.linkedIn} />
                          <div className="currentSituationDivError"  style={{display: (this.state.linkedIn === '') && (this.state.errorModal === true) ? 'block' : 'none', marginLeft: 'auto', marginRight: 'auto', marginTop: '-1%'}}>⚠ Molim te ispuni polje</div>
                        </div>
                    ...
                    <div className="PotentionalClientsModalBtn" style={{marginLeft: '45%', marginBottom:'2%'}} onClick={this.technicalInfoSendHandler}>
                        <img src={save} /> 
                        <div>Spremi</div>
                    </div>
                ...
                <div className="billModal" style={{display: this.state.billHandler ? 'flex' : 'none'}}>

                  <div onClick={this.billCloseHandler}  className="PotentionalClientsModalBtn" style={{marginLeft: '13%'}}>
                    <img src={close} /> 
                    <div>Zatvori</div>
                  </div>

                  <h5>Upiši OIB tvrtke:</h5>
                  <input onChange={(e)=>this.delayChangeHandler(e)} className="InputElement" name="billName" type="number" value={this.state.billName} />
                  <div className="currentSituationDivError"  style={{display: (this.state.billName === '') && (this.state.errorModal === true) ? 'block' : 'none', marginLeft: 'auto', marginRight: 'auto', marginTop: '-1%'}}>⚠ Molim te ispuni polje</div>

                  <div className="PotentionalClientsModalBtn" style={{marginLeft: '40%'}} onClick={this.billSaveHandler}>
                    <img src={save} /> 
                    <div>Spremi</div>
                  </div>
                ...
                <div className="deleteModal" style={{display: this.state.createBill ? 'flex' : 'none'}}>
                  <img src={confirm} /> 
                  <div>Račun Je Kreiran</div>
                </div>
                ...
                <div style={{display: (this.state.PotentionalClientsModal === true) || (this.state.delay === true) || (this.state.billHandler === true) || (this.state.technicalInfoModal === true) ? 'block' : 'none'}} className="Backdrop"></div>
                ...
                <div onClick={this.closeHandler} className="PotentionalClientsModalBtn">
                  ...
                  <div className="PotentionalClientsModalDivWrapp">
                    ...
                    <div className="PotentionalClientsModalDiv">
                      ...
                      <h5>Vrsta usluge</h5>
                      <div className="allServicesInput" onClick={this.allServicesInputHandler}>
                        {
                         this.state.allServicesClick ? <img src={switchD} /> : <img src={switchL} />
                        }                      
                      </div>

                      <div className="allServices" style={{display: this.state.allServicesClick ? 'flex' : 'none'}}>
                        {
                          this.state.allServices.map(s => (
                            <div key={s.id} onClick={(e)=>this.serviceHandler(e,s.id)} style={{background: s.active ? '#bfc4cc' : 'none'}}>{s.title}</div>
                          ))
                        }
                      </div>

                      <div className="currentSituationDivError"  style={{display: (this.state.service === '') && (this.state.errorModal === true) ? 'block' : 'none'}}>⚠ Molim te ispuni polje</div>
