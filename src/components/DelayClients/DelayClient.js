     ...
     content: [
          ...
          },
        {
          ...
          table: {
            ...
            body: [
                [ { text: 'Rbr.', style: 'headerStyle'} , { text: 'Šifra', style: 'headerStyle'}, { text: 'Naziv usluge', style: 'headerStyle'}, { text: 'Količina', style: 'headerStyle'}, { text: 'Pojedinačna cijena (HRK)', style: 'headerStyle', margin: [2, 2],}, { text: 'Ukupno (HRK)', style: 'headerStyle'} ],
      ...
      clientsMap = potentionalClients.map(p => (
            ...
            <div className="PotentialClient" key={p.name + p.surname + p.problem} style={{display: (p.potentional===false) && (p.delayName===true) && (p.check!==true) ? 'block' : 'none'}}>
                ...
                <div className="PotentialClientDelay">
                  {p.delayName ? 
                      <div>{'Odgođeno za: ' + p.delayDate[p.delayDate.length-1].display}</div>
                    : null
                  }
                </div>
